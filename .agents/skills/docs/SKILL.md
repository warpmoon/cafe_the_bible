---
name: docs
description: Documentation guidelines for cafe_the_bible
---

# Documentation: cafe_the_bible

This guide applies to documentation work under `docs/`.

## Language and Format

- Write documentation in Markdown.
- Use Korean as the main language.
- Use English for code identifiers, commands, endpoint names, and common technical terms.
- Keep explanations clear, concise, and current with the code.
- Prefer short sections, examples, and tables when they make information easier to scan.
...
- If a feature is not implemented, mark it clearly as planned or omit it.
- When code and docs disagree, treat code as the source of truth and update the docs.
